    ...
    >
      <form onSubmit={(e) => nextStep(e)}>
        ...
        <Group position="center" mt="xl">
          <Button size='xs' radius='sm' color='cyan' className='bg-cyan-800' onClick={prevStep}>Back</Button>
          <Button type='submit'size='xs' radius='sm' color='cyan' className='bg-cyan-800' onClick={nextStep}>Next</Button>
        </Group>
        {/* <TextInput
          className='mb-2'
          label='Email'
